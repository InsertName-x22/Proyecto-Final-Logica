public class Programa {
    ...
    public static void main(String[] args) {
            ...
            System.out.println(A + "                                 |                                                                                                                   |             ");
            System.out.println(A + "                                 |                                                                                                                   |         ");
            System.out.println(A + "                                 |" + CYAN + "     ⡆⣐⢕⢕⢕⢕⢕⢕⢕⢕⠅⢗⢕⢕⢕⢕⢕⢕⢕⠕⠕⢕⢕⢕⢕⢕⢕⢕⢕⢕                             ⡆⣐⢕⢕⢕⢕⢕⢕⢕⢕⠅⢗⢕⢕⢕⢕⢕⢕⢕⠕⠕⢕⢕⢕⢕⢕⢕⢕⢕⢕      " + A + "|                                                                ");
            System.out.println(A + "                                 |" + CYAN + "     ⢐⢕⢕⢕⢕⢕⣕⢕⢕⠕⠁⢕⢕⢕⢕⢕⢕⢕⢕⠅⡄⢕⢕⢕⢕⢕⢕⢕⢕⢕                             ⢐⢕⢕⢕⢕⢕⣕⢕⢕⠕⠁⢕⢕⢕⢕⢕⢕⢕⢕⠅⡄⢕⢕⢕⢕⢕⢕⢕⢕⢕      " + A + "|                                                                ");
            System.out.println(A + "                                 |" + CYAN + "     ⢕⢕⢕⢕⢕⠅⢗⢕⠕" + A + "⣠⠄" + CYAN + "⣗⢕⢕⠕⢕⢕⢕⠕" + A + "⢠⣿" + CYAN + "⠐⢕⢕⢕⠑⢕⢕⠵⢕                             ⢕⢕⢕⢕⢕⠅⢗⢕⠕" + A + "⣠⠄" + CYAN + "⣗⢕⢕⠕⢕⢕⢕⠕" + A + "⢠⣿" + CYAN + "⠐⢕⢕⢕⠑⢕⢕⠵⢕      " + A + "|                                                                 ");
            System.out.println(A + "                                 |" + CYAN + "     ⢕⢕⢕⢕⠁⢜⠕⢁" + A + "⣴⣿⡇" + CYAN + "⢓⢕⢵⢐⢕⢕⠕⢁" + A + "⣾⢿⣧" + CYAN + "⠑⢕⢕⠄⢑⢕⠅⢕                             ⢕⢕⢕⢕⠁⢜⠕⢁" + A + "⣴⣿⡇" + CYAN + "⢓⢕⢵⢐⢕⢕⠕⢁" + A + "⣾⢿⣧" + CYAN + "⠑⢕⢕⠄⢑⢕⠅⢕      " + A + "|                                                                 ");
            System.out.println(A + "                                 |" + CYAN + "     ⢕⢕⠵⢁⠔⢁" + A + "⣤⣤⣶⣶⣶" + CYAN + "⡐⣕⢽⠐⢕⠕⣡" + A + "⣾⣶⣶⣶⣤" + CYAN + "⡁⢓⢕⠄⢑⢅⢑           " + A + "Opcion 1          " + CYAN + "⢕⢕⠵⢁⠔⢁" + A + "⣤⣤⣶⣶⣶" + CYAN + "⡐⣕⢽⠐⢕⠕⣡" + A + "⣾⣶⣶⣶⣤" + CYAN + "⡁⢓⢕⠄⢑⢅⢑      " + A + "|    ");
            System.out.println(A + "                                 |" + CYAN + "     ⠍⣧⠄" + A + "⣶⣾⣿⣿⣿⣿⣿⣿⣷⣔" + CYAN + "⢕⢄⢡" + A + "⣾⣿⣿⣿⣿⣿⣿⣿⣦" + CYAN + "⡑⢕⢤⠱⢐           " + A + "Opcion 2          " + CYAN + "⠍⣧⠄" + A + "⣶⣾⣿⣿⣿⣿⣿⣿⣷⣔" + CYAN + "⢕⢄⢡" + A + "⣾⣿⣿⣿⣿⣿⣿⣿⣦" + CYAN + "⡑⢕⢤⠱⢐      " + A + "|     ");
            System.out.println(A + "                                 |" + CYAN + "     ⢠⢕⠅" + A + "⣾⣿⠋⢿⣿⣿⣿⠉⣿⣿⣷⣦⣶⣽⣿⣿⠈⣿⣿⣿⣿⠏⢹⣷⣷⡅" + CYAN + "⢐           " + A + "Opcion 3          " + CYAN + "⢠⢕⠅" + A + "⣾⣿⠋⢿⣿⣿⣿⠉⣿⣿⣷⣦⣶⣽⣿⣿⠈⣿⣿⣿⣿⠏⢹⣷⣷⡅" + CYAN + "⢐      " + A + "|           ");
            System.out.println(A + "                                 |" + CYAN + "     ⣔⢕⢥" + A + "⢻⣿⡀⠈⠛⠛⠁⢠⣿⣿⣿⣿⣿⣿⣿⣿⡀⠈⠛⠛⠁⠄⣼⣿⣿⡇" + CYAN + "⢔           " + A + "Opcion 4          " + CYAN + "⣔⢕⢥" + A + "⢻⣿⡀⠈⠛⠛⠁⢠⣿⣿⣿⣿⣿⣿⣿⣿⡀⠈⠛⠛⠁⠄⣼⣿⣿⡇" + CYAN + "⢔      " + A + "|                  ");
            System.out.println(A + "                                 |" + CYAN + "     ⢕⢕⢽" + A + "⢸⢟⢟⢖⢖⢤⣶⡟⢻⣿⡿⠻⣿⣿⡟⢀⣿⣦⢤⢤⢔⢞⢿⢿⣿⠁" + CYAN + "⢕           " + A + "Opcion 5          " + CYAN + "⢕⢕⢽" + A + "⢸⢟⢟⢖⢖⢤⣶⡟⢻⣿⡿⠻⣿⣿⡟⢀⣿⣦⢤⢤⢔⢞⢿⢿⣿⠁" + CYAN + "⢕      " + A + "|         ");
            System.out.println(A + "                                 |" + CYAN + "     ⢕⢕⠅" + RED + "⣐⢕⢕⢕⢕⢕" + A + "⣿⣿⡄⠛⢀⣦⠈⠛⢁⣼⣿" + RED + "⢗⢕⢕⢕⢕⢕⢕⡏" + CYAN + "⣘⢕            " + A + "Salir            " + CYAN + "⢕⢕⠅" + RED + "⣐⢕⢕⢕⢕⢕" + A + "⣿⣿⡄⠛⢀⣦⠈⠛⢁⣼⣿" + RED + "⢗⢕⢕⢕⢕⢕⢕⡏" + CYAN + "⣘⢕      " + A + "|             ");
            System.out.println(A + "                                 |" + CYAN + "     ⢕⢕⠅" + RED + "⢓⣕⣕⣕⣕⣵" + A + "⣿⣿⣿⣾⣿⣿⣿⣿⣿⣿⣿" + RED + "⣷⣕⢕⢕⢕⢕⡵" + CYAN + "⢀⢕⢕                             ⢕⢕⠅" + RED + "⢓⣕⣕⣕⣕⣵" + A + "⣿⣿⣿⣾⣿⣿⣿⣿⣿⣿⣿" + RED + "⣷⣕⢕⢕⢕⢕⡵" + CYAN + "⢀⢕⢕      " + A + "|                                                                        ");
            System.out.println(A + "                                 |" + CYAN + "     ⢑⢕⠃⡈" + A + "⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿" + CYAN + "⢃⢕⢕⢕                             ⢑⢕⠃⡈" + A + "⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿" + CYAN + "⢃⢕⢕⢕      " + A + "|                                                                      ");
            System.out.println(A + "                                 |" + CYAN + "     ⣆⢕⠄⢱⣄" + A + "⠛⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠿" + CYAN + "⢁⢕⢕⠕⢁                             ⣆⢕⠄⢱⣄" + A + "⠛⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠿" + CYAN + "⢁⢕⢕⠕⢁      " + A + "|                                                                 ");
            System.out.println(A + "                                 |" + CYAN + "     ⣿⣦⡀⣿⣿⣷⣶⣬" + A + "⣍⣛⣛⣛⡛⠿⠿⠿⠛⠛⢛⣛⣉⣭" + CYAN + "⣤⣂⢜⠕⢑⣡⣴⣿                             ⣿⣦⡀⣿⣿⣷⣶⣬" + A + "⣍⣛⣛⣛⡛⠿⠿⠿⠛⠛⢛⣛⣉⣭" + CYAN + "⣤⣂⢜⠕⢑⣡⣴⣿      " + A + "|                 ");
